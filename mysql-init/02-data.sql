...
INSERT INTO permissions (gid,domain,action) VALUES (@reviewer_gid, 'Ideas', 'READ_SHARED, CREATE-COMMENT_SHARED');
...
INSERT INTO permissions (gid,domain,action) VALUES (@inventor_gid, 'Ideas', 'CREATE-COMMENT_OWN, READ-COMMENT_OWN');
INSERT INTO permissions (gid,domain,action) VALUES (@inventor_gid, 'Comments', 'DELETE_OWN, EDIT_OWN');
