...
INSERT INTO groups VALUES (4, 3, 'shared-idea-inventors', 'Inventors that can work with shared ideas');
SET @shared_iventors_gid = (SELECT id FROM groups WHERE name = 'shared-idea-inventors');
INSERT INTO permissions VALUES (0, @shared_iventors_gid, null, 'IdEaS', null, 'READ_OWN, EDIT_OWN');
...
INSERT INTO ideas VALUES (13, 3, null, @shared_iventors_gid, 'shared-idea1@emca', 'the 1st shared idea at emca' );
INSERT INTO ideas VALUES (14, 3, null, @shared_iventors_gid, 'shared-idea2@emca', 'the 2nd shared idea at emca' );
